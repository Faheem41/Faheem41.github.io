...
function cButton() {
    alert("A lot of free materials have been used in this site. Provided that this site is not used for any business purpose, still if the owner of any of the materials have any objection then please contact faheem2941@outlook.com .");
}
...
function main(user) {
    ...
    if (isUser==2) {
        ...
        if (n==30) {
            ...
            alert("You win with point " + pt + ". Congrats! You have saved the queen.");
            return;
        }
        map[n+1].innerHTML = map[n].innerHTML;
        map[n].innerHTML = "<img src=" + seq[n][1] +"></img>";
        point.innerHTML = map[n+1][2];
        n += 1;
    }
